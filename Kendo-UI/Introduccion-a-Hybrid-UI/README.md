...
<div id="home" data-role="view" data-layout="default" data-model="newsReaderViewModel">
	...
	<script id="newsRowTemplate" type="text/x-kendo-template">
		<ul>
			<li><a data-rel="modalview" data-role="button" href="\#detail" data-content="#: content #" data-image="#: image #">#: title #</a></li>
		</ul>
	</script>
</div>
```
...
De esta forma ya los bindings funcionan correctamente y el html final debería verse así:
